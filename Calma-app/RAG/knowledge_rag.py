...
class MentalHealthKnowledgeRAG:
    ...
    def __init__(self,
                 knowledge_base_path: str = 'datos/base_conocimiento_rag_pasos_inmediatos.json',
                 openai_model: str = 'text-embedding-3-small',
                 index_path: str = 'datos/faiss_pasos/knowledge_index.bin',
                 metadata_path: str = 'datos/faiss_pasos/knowledge_metadata.pkl',
        ...
        if not os.path.isabs(knowledge_base_path):
            knowledge_base_path = os.path.join(calma_app_dir, knowledge_base_path)
