...
export function BottomNav() {
  ...
  const [active, setActive] = useState<"home" | "historial" | "especialistas">(getActiveRoute())
  ...
  const navItems = [
    { id: "historial" as const, label: "Historial", icon: "historial", path: "/historial" },
  ...
  const handleNavClick = (id: "home" | "historial" | "especialistas", path: string) => {
    setActive(id)
    router.push(path)
  }
